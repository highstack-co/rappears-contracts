# shiboost-eth-bsc-bridge
ETH/BSC Bridge for the SHIBOOST Token

## Installation/Setup

### Address Configuration
Before doing anything, edit `addressConfig.js` and set the addresses for every network you will be working with.
- `ADDR_SHIBOOST`: The SHIBOOST address
  - This should not change in `BSC_MAIN` since it's already deployed there
- `ADDR_MARKETING`: The SHIBOOST MARKETING address (for testing, set this to your account)
- `ADDR_DEV`: The SHIBOOST Dev address (for testing, set this to your account)
- `ADDR_LP`: The SHIBOOST LP address (for testing, set this to your account)
- `ADDR_STAKING`: The SHIBOOST Staking address (for testing, set this to your account)
- `ADDR_UNISWAP`: The address where Uniswap is deployed
    - This should not change in the main networks since it's already deployed there
- `ADDR_BRIDGE`: The address of the `SHIBOOSTBridge`
- `ADDR_BRIDGE_ADMIN`: The address of the account that will manage the SHIBOOSTBridge's funds
